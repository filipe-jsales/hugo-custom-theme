	...
	<div class="analyst-modal-content" style="width: 450px">
		...
		<div style="display: flex">
			...
			<div class="analyst-install-description-block">
				<strong class="analyst-modal-header">Silence is golden</strong>
				<p class="analyst-install-description-text">Agree with our terms and conditions.</p>
			</div>
		</div>
		...
		<div class="analyst-install-footer analyst-modal-def-top-padding">
			...
			<span id="analyst-powered-by" style="display: none;">Powered by <a href="https://webera.com" target="_blank" class="analyst-link">Webera.com</a></span>
