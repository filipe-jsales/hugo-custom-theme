...
<div id="bmi" style="display: none;">
  ...
  <!-- Plugin Title -->
  <div class="heading f30 semibold" style="text-align: center;">
    <?php _e('Welcome to GM Migration!', 'backup-backup'); ?>
  </div>
  ...
  <div class="tab-wrapper" id="create-backup-wrapper">
    ...
    <div class="collapser section-bmi shadow" id="exlucde-parts" group="configuration" style="display: none;">
    ...
    <div class="collapser section-bmi shadow" group="configuration" style="display: none;">
      <div class="header f20 pointer transition">
    ...
    <!-- SECTION DIVIDER -->
    <hr class="section-bmi" style="display: none;">

    <!-- GLOBAL CONFIGURATION -->
    <div class="collapser section-bmi shadow" id="other-options" group="configuration" style="display: none;">
    ...
    <!-- TROUBLESHOOTING -->
    <div class="collapser section-bmi shadow" id="troubleshooting-chapter" group="configuration" style="display: none;">
