  ...
  <div class="modal-wrapper no-hpad no-vpad" style="max-width: 900px; max-width: min(900px, 80vw)">
    ...
    <div class="modal-content">
      ...
      <div class="prenotices">
        <div class=" center f20 mblll mtlll">
        <img class="mbll mtll" src="<?php echo $this->get_asset('images', 'greenmainframe-logo.png'); ?>" alt="success">

        </div>
        <div class="center prenotice red">
          <div class="text bold">
      ...
      <div class="mm60 center mbl f18" style="display: none;">
