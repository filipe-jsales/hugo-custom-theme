...
<div class="modal modal-no-close" id="restore-success-modal">
  ...
  <div class="modal-wrapper no-hpad" style="max-width: 900px; max-width: min(900px, 80vw)">
    <div class="modal-content center">
      ...
      <div class="mm60 f35 bold black mbl mtl"><?php _e('Migration successful!​', 'backup-backup') ?></div>
      <img class="mb mtl" src="<?php echo $this->get_asset('images', 'smile.png'); ?>" alt="success">

      <div class="mbl f20 lh30" style="display: none;">
      ...
      <?php if (!defined('BMI_BACKUP_PRO')) : ?>
        <div class="cf mb inline center block suc-buttns">
          <div class="left a1" style="display: none;">
          ...
          <div class="left a2" style="display: none;">
      ...
      <div class="center mbl">
        <a href="#" class="btn max280 bold nodec site-reloader">
          <?php _e("Ok, close", 'backup-backup'); ?>
        </a>
      </div>

      <div class="center f17 mbl">
        <a href="#!" class="download-restore-log-url" style="text-align: center;" download="restoration_logs.txt">
          <?php _e("Download the log", 'backup-backup'); ?></a>
      </div>
